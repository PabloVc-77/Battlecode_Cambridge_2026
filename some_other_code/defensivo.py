...
BASE_LAYOUT = [
    ...
    ( 2, -1, EntityType.CONVEYOR, "conveyor", Direction.SOUTH, 1),  # CYv SOUTH=+dy toward Sv
    ( 2,  0, EntityType.SPLITTER, "splitter", Direction.SOUTH, 1),  # Sv  SOUTH=+dy toward core-bot

    # Priority 2 — foundry chain
    (-1, -2, EntityType.SPLITTER, "splitter", Direction.WEST,  2),  # <S

    # Priority 3 — sentinels & Foundry
